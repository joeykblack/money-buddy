...
const THEME_DEFINITIONS = {
  ...
  butterflyking: {
    ui: {
      subtitle: 'Bright wings, bold colors, and gentle momentum. 🦋',
      header: 'Money Buddy 🦋',
      sectionHeadings: {
        today: 'Today in Bloom 🌈',
        monthly: 'Butterfly Budget Flight 💸',
        other: 'Garden Tasks 🧾',
        taxes: 'Seasonal Planning 📅',
        history: 'Colorful Journey 📖',
      },
    },
    homeCardIds: {
      card: 'butterflyking-theme-card',
      startMessage: 'butterflyking-start-message',
      image: 'butterflyking-image',
    },
    imageProvider: {
      type: 'static',
      images: [
        'butterflyking/1.jpg',
        'butterflyking/2.jpeg',
        'butterflyking/3.jpg',
        'butterflyking/4.jpg',
        'butterflyking/5.jpg',
        'butterflyking/6.jpg',
        ...
        'butterflyking/8.jpg',
        'butterflyking/9.jpg',
        'butterflyking/10.jpg',
      ],
    },
    messages: {
      start: [
        'Open those wings. We’re flying through this list. 🦋',
        'Colorful energy only — let’s begin! 🌈',
        'Tiny steps, bright results. You’ve got this. ✨',
        'The garden is ready. Let’s bloom. 🌸',
        'Light, focused, and fabulous. Start now. 💫',
        'You bring the color. I’ll bring the plan. 🎨',
        'One graceful move at a time. 🌼',
        'Today is for progress and pretty victories. 💐',
        'A gentle start becomes a gorgeous finish. 🫶',
        'Flutter forward — we’re doing great already. 🪽',
      ],
      step: [
        'Beautiful work. Another wingbeat forward. 🦋',
        'So smooth. You’re glowing with momentum. ✨',
        'That step looked effortless and bright. 🌈',
        'Lovely progress — keep fluttering. 🌸',
        'You’re making this checklist bloom. 💐',
        'One more colorful win in the bag. 🎨',
        'Graceful, calm, and done. 🌼',
        'That was a brilliant move. 💫',
        'Look at you go — pure butterfly energy. 🪽',
        'Another petal-perfect step complete. 🫶',
      ],
      final: [
        'All done — a full rainbow of wins. 🌈',
        'You finished beautifully. Be proud. 🦋',
        'Every step complete. Absolute bloom energy. 🌸',
        'A colorful day, handled perfectly. ✨',
        'Checklist complete and looking fabulous. 💐',
        'You flew through everything with style. 🪽',
        'What a graceful finish. Mission complete. 💫',
        'You turned tasks into art today. 🎨',
        'Bright focus, bright finish, bright future. 🌼',
        'The Butterfly King would be impressed. 👑🦋',
      ],
    },
  },
  bassethound: {
    ui: {
      subtitle: 'Long ears, loyal heart, slow and steady wins the race. 🐕‍🦺',
      header: 'Money Buddy 🐕‍🦺',
      sectionHeadings: {
        today: 'Today\'s Pace 🐾',
        monthly: 'Monthly Trots 💸',
        other: 'Gentle Tasks 🧾',
        taxes: 'Yearly Rests 📅',
        history: 'Loyal Records 📖',
      },
    },
    homeCardIds: {
      card: 'bassethound-theme-card',
      startMessage: 'bassethound-start-message',
      image: 'bassethound-image',
    },
    imageProvider: {
      type: 'static',
      images: [
    ...
    messages: {
      start: [
        'Let\'s get comfy and get going, friend. 🐕‍🦺',
        'No rush. One paw in front of the other. 🐾',
        'You\'ve got this. I believe in you. 💙',
        'Slow and steady, just like me. 🐕',
        'Let\'s do this together, nice and easy. 🐾',
        'One step at a time, no pressure. 😌',
        'I\'m right here with you, buddy. 🐕‍🦺',
        'Droopy ears, steady paws, loyal heart. 💛',
        'We can do this. Take your time. 🐾',
        'You\'re gonna be great. I just know it. 🐕',
      ],
      step: [
        'Atta boy. Keep going. 🐾',
        'You\'re doing great, friend. 🐕',
        'Nice work. Real nice. 💙',
        'One step closer. We got this. 🐕‍🦺',
        'Slow and steady, just right. 😌',
        'I\'m so proud of you. 💛',
        'You\'re on a roll. Keep going. 🐾',
        'That\'s my friend. So good. 🐕',
        'You make it look easy. 💙',
        'Steady paws, steady progress. 🐕‍🦺',
      ],
      final: [
        'All done, buddy. You did it. 🐾',
        'I\'m so proud. You crushed it. 🐕',
        'We made it to the finish line together. 💙',
        'Mission accomplished, friend. 🐕‍🦺',
        'You were loyal and steady. Great job. 💛',
        'Look at you go. Absolutely wonderful. 🐾',
        'One step at a time, we did it. 🐕',
        'You earned a long nap. Well done. 😌',
        'The best boy. That\'s you. 💙',
        'From start to finish, you were perfect. 🐕‍🦺',
      ],
    },
  },
};
